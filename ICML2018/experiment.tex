...
In this case, how the tasks are assigned does not affect the comparison and thus we let every worker get assigned the whole task set (i.e. $\forall i, m_i^t = M$).% \yitao{@yang, I am not sure about the last 3 sentence, please take a look.}
