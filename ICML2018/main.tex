...
In this paper, we propose a novel sequential data acquisition mechanism which is consists of three parts, that is the payment rule, the Bayesian inference and the RL algorithm.
