...
Then, we propose a reinforcement learning algorithm, relying on the above estimates, to uncover how workers respond to differently offered incentive levels. Our mechanism determines the payment for workers based on workers' current strategies and the output of the reinforcement learning algorithm.
