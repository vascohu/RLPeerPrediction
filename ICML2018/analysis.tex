...
%        \caption{\label{BIM1}}
%    \end{subfigure}
    \caption{\label{BIM} Empirical analysis on our Bayesian inference algorithm. (a) Average payment per task given true label's distribution. (b) Average payment per task given PoBCs of workers excluding $i$. (c) The standard variance of the payment given worker $i$'s PoBC.}
\vspace{-2mm}
\end{figure*}
