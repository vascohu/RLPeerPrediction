...
RL has made several breakthroughs of achieving human-level performance in challenging domains \citep{Mnih15,Silver17}. More gladly, many studies successfully deploy it to solve some social problems \citep{Leibo2017,Adam17}. Besides, RL has also helped make advances in human-agent collaboration \citep{MathewsonP16,Wang2017}.
